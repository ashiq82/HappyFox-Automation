...
the results across all page_objects::
...
a request)::
    ...
    >>> for page in results_iterator.page_objects:
    ...     print('=' * 20)
...
class Iterator(object, metaclass=abc.ABCMeta):
    ...
    @property
    def pages(self):
        """Iterator of page_objects in the response.
    ...
    def _page_iter(self, increment):
        """Generator of page_objects of API responses.
...
class HTTPIterator(Iterator):
    ...
    def _next_page(self):
        ...
        Returns:
            Optional[Page]: The next page in the iterator or :data:`None` if
                there are no page_objects left.
        """
    ...
    def _has_next_page(self):
        """Determines whether or not there are more page_objects with results.

        Returns:
            bool: Whether the iterator has more page_objects.
        """
...
class GRPCIterator(Iterator):
    ...
    def _has_next_page(self):
        ...
        # can return an empty string indicating no more page_objects.
