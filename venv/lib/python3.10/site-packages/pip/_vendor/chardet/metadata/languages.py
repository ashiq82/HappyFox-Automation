...
class Language(object):
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia page_objects to start from if we're crawling
...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             # simple way to get the Latin alphabet page_objects from Wikipedia through
             ...
             'Vietnamese': Language(name='Vietnamese',
                                    ...
                                    # dozens of 8-bit Vietnamese code page_objects are
